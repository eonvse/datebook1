<x-filament-widgets::widget>
    <x-filament::section>
        <div class='flex items-center gap-x-3'>
            ...
            <a href="{{ route('start') }}"
                        class="fi-link group/link relative inline-flex items-center justify-center outline-none fi-size-md fi-link-size-md gap-1.5  fi-color-gray" rel="noopener noreferrer"
            >
                <svg class="fi-link-icon h-5 w-5 text-gray-400 dark:text-gray-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" data-slot="icon">
